...
namespace P02_2019MA603_2020VH602_2020VD601.Controllers
{
    public class generosController : Controller
    {
        ...
        public generosController(casosCovidContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index()
        {
              return _context.generos != null ? 
                          ...
                          Problem("Entity set 'casosCovidContext.generos'  is null.");
        }
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'casosCovidContext.generos'  is null.");
            }
            var generos = await _context.generos.FindAsync(id);
            if (generos != null)
            {
